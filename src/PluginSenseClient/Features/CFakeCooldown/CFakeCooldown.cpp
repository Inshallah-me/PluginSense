...
{
	// ------------------------------------------------------------------ 冷却类型
	// 冷却类型(写入 qword_1823BF914 高 32 位),决定 GetCooldownType / GetCooldownReason / CooldownIsPermanent。
	...
	// ------------------------------------------------------------------ 同步冷却 / VAC 封禁到内存
	// 冷却:写 qword_1823BF914 + flag;Official Ban = 类型 8 永久;VAC 封禁:写 dword_1823BF91C。
