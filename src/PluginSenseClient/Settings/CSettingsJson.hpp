...
private:
	...
	auto GetTextJson( const rapidjson::Value& JsonValue , const char* Name , char* Output , size_t OutputSize ) -> void;
...
private:
	...
	auto AddTextJson( rapidjson::PrettyWriter<rapidjson::OStreamWrapper>& Writer , const char* Name , const char* Output ) -> void;
