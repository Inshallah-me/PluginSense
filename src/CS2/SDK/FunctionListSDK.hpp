...
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( float , IGameEvent_GetFloat , ( IGameEvent* pIGameEvent , const char* szEventName , float defaultValue ) , ( IGameEvent* , const char* , float ) , ( pIGameEvent , szEventName , defaultValue ) );
...
// Particle system
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( int* , ParticleCreateEffect , ( void* particle_manager , int* effect_index , const char* path , int flags , int64_t unk1 , int64_t unk2 , int64_t unk3 , int unk4 ) , ( void* , int* , const char* , int , int64_t , int64_t , int64_t , int ) , ( particle_manager , effect_index , path , flags , unk1 , unk2 , unk3 , unk4 ) );
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( bool , ParticleSetControlPoint , ( void* particle_manager , std::uint32_t effect_index , int control_point , void* data , int unk ) , ( void* , std::uint32_t , int , void* , int ) , ( particle_manager , effect_index , control_point , data , unk ) );
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( bool , ParticleSetEntityBinding , ( void* particle_manager , std::uint32_t effect_index , int control_index , void* entity , int unk1 , void* unk2 , void* unk3 , int unk4 , int unk5 ) , ( void* , std::uint32_t , int , void* , int , void* , void* , int , int ) , ( particle_manager , effect_index , control_index , entity , unk1 , unk2 , unk3 , unk4 , unk5 ) );
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( bool , ParticleSetTransform , ( void* particle_manager , std::uint32_t effect_index , int unk , void* transform , int unk2 ) , ( void* , std::uint32_t , int , void* , int ) , ( particle_manager , effect_index , unk , transform , unk2 ) );
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( void , ParticleDestroyEffect , ( void* particle_manager , std::uint32_t effect_index , bool unk1 , bool unk2 ) , ( void* , std::uint32_t , bool , bool ) , ( particle_manager , effect_index , unk1 , unk2 ) );
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( void , InitParticlePathBuffer , ( void* buffer , const char* path ) , ( void* , const char* ) , ( buffer , path ) );
DECLARATE_CS2_FUNCTION_SDK_FASTCALL( void , ResourceSystemLoad , ( void* resource_system , void* buffer , const char* unk ) , ( void* , void* , const char* ) , ( resource_system , buffer , unk ) );
