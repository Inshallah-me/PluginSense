...
public:
	...
	*/
	...
	CBasePattern ResourceSystemLoad = { VmpStr( "ResourceSystemLoad" ) , VmpStr( "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B 01" ) , RESOURCESYSTEM_DLL , 0 , SEARCH_TYPE_NONE };
